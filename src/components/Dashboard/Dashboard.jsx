...
import { Album, Badge, BookText, Building2, ChevronLeft, ChevronRight, Combine, CreditCard, Divide, FileStack, FileType2, HandCoins, Leaf, Mails, Plus, Trash2 } from 'lucide-react';
...
import { getDashboardCount, getDocumentDrafts, getUserSignature, getcontactCount } from '../../Apis/legalAgreement';
                ...
                <div className='col-span-8 lg:col-span-6'>
                    ...
                    <div className='flex flex-col lg:flex-row  w-full gap-5 pt-5 justify-between'>
                        ...
                        <div className='border rounded-md w-full'>
                            ...
                            {drafts && drafts.length > 0 && DraftPage.maxPage > 1 && (
                ...
                <div className='col-span-8 lg:col-span-2 lg:border-l-2 lg:border-t-0 border-t-2 pl-0 lg:pl-4'>
                    <div className='flex flex-col justify-between gap-4'>
                        <div className=''>
                            ...
                            <div className='flex flex-col border rounded-md  w-full my-auto'>
                                <div className='px-4 py-2 text-start bg-[#e8eff6] text-[16px] font-[500]'><h1>    Team Settings</h1></div>

                                <div className='border-t-2 text-[16px]'>
                                    <div className="p-4 flex flex-col">
                                        <label className='font-[600]' htmlFor="doctitle">Team Name <span className='text-red-700'>*</span> </label>
                                        <input
                                            type="text"
                                            value={bussinessName}
                                            onChange={(event) =>
                                            ...
                                            className="border  py-1 px-3 mt-2 min-h-[47px]"
                                        />
                                    </div>
                                    <div className='px-4 flex flex-row justify-between pb-4'>
                                        <span className='font-[600]' htmlFor="doctitle">{`Team's Logo`} </span >
                                        {teamData ? (
                                                        ...
                                                        if (window.FileReader && event.target.files[0]) {
                                                            ...
                                                            if (
                                                                ...
                                                                file.onload = function () {
                                                                    setTeamData(event.target.files[0])
