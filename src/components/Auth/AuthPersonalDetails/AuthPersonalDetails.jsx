    ...
    onSubmit: async (values) => {
      ...
      if (response.data) {
        ...
        if (router?.query?.id && router?.query?.id !== "undefined") {
          router.push(`/onboarding/success?id=${router?.query?.id}`);
        } else {
          router.push(`/upgrade`);
        }
      }
    ...
    <>
      <header className="py-4 fixed top-0 w-full border-b bg-[#056a70ff]">
        <div className="container flex items-center justify-between">
          {!isBelow990px ? (
            <Image width={170} height={50} src={"/images/logo-dark.png"} />
          ) : (
            <Image
              width={30}
              height={30}
      ...
      <div className="h-screen flex items-center">
        <div className="md:w-[40%] md:mt-10 w-4/5 mt-[50px] flex flex-col mx-auto  mb-[20px]">
          <Typography
            className="md:text-[17px] -mt-[15px]"
          ...
          <Typography
            ...
            className="md:text-[14px] -mt-[2px]"
          >
            Upload your profile picture
          </Typography>
          <div className="flex items-center w-full justify-between mb-7">
            <div className="flex justify-center bg-white border rounded-[50%] p-1 items-center md:mt-[-14px]">
              {profileImage ? (
                <img
                  style={{
                    width: "45px",
          ...
          <div className="flex justify-between items-center mt-[10px]">
            <div className="flex items-center gap-4">
              ...
              <Typography
                className="sm:-ml-[12px] md:-ml-[12px] lg:-ml-[12px]"
          ...
          <div className="w-full flex justify-end items-center mt-[20px]">
            <Button
              ...
              size="sm"
              className="font-semibold rounded-full bg-[#05686E] text-background px-5 self-end md:-mt-[15px]"
            >
              Continue
            </Button>
          </div>
