  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {imageBoxOpen ? (
            <div className="w-full flex border border-dotted border-[#d3d3d3]" onClick={handleClick}>
              <input
                // accept={accept}
                // multiple={multiple}
                type="file"
            ...
            <span
              className="text-[10px] lg:text-[16px] whitespace-nowrap capitalize"
              onClick={() => setImageBoxOpen(true)}
            >
