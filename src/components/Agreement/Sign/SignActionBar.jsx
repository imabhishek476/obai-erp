...
const SignActionBar = ({
  ...
  useEffect(()=>{
    setItemObject(groupBy(items, ({ field }) => field))
  // console.log(Object.groupBy(items, ({ field }) => field))
  },[items])
  const getIcon = (field) => {
    switch (field) {
      case "Signature":
        return <DrawIcon className="fill-white" />;
      case "Initials":
  ...
  return (
    <div className="hidden lg:block col-span-2 h-full bg-gray-50  border-l border-t border-gray-400">
      <div>
