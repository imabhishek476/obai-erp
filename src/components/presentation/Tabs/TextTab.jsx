...
const getBasicTextItem = (pageIndex, variant, container,items) => {
  ...
  if(container){
    ...
    transformStr = {translate:[width/2, height/2,0]}
  }
    ...
    <div className="flex-col gap-2">
      ...
      <Button
        ...
        onPress={() => {
          ...
          addItem(getBasicTextItem(selectedPage?.pageIndex || 0,"base",document.getElementById("currentPage"),items))
        }}
      >
        Add Text Box
      </Button>
      ...
      <Button
        ...
        onPress={() => {
          setIsDragginginStore((prev)=>!prev)
          addItem(getBasicTextItem(selectedPage?.pageIndex || 0, "heading",document.getElementById("currentPage"),items))
        }}
      >
        Add a heading
      </Button>
      <Button
        ...
        onPress={() => {
          setIsDragginginStore((prev)=>!prev)
          addItem(getBasicTextItem(selectedPage?.pageIndex || 0,"subHeading",document.getElementById("currentPage"),items))
        }}
      >
        Add a subheading
      </Button>
      <Button
        ...
        onPress={() => {
          setIsDragginginStore((prev)=>!prev)
          addItem(getBasicTextItem(selectedPage?.pageIndex || 0,"body",document.getElementById("currentPage"),items))
        }}
      >
