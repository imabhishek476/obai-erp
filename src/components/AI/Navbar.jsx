  ...
  return (
    <>
      ...
      >
        ...
        >
          <Button className="hidden md:flex text-[#05686e] border border-[#05686e] rounded-full bg-inherit   w-max">
            CTA 1
          </Button>
          <Button className="hidden md:flex  rounded-full bg-[#05686E] text-background  w-max">
            CTA 2
          </Button>
          {details?.data && (
